...
export default function BusinessCategoriesPage() {
  ...
  async function handleAddCategory(e: React.FormEvent) {
    ...
    try {
      ...
      if (editCategoryId) {
        // Edit mode
        res = await fetch(`/api/business/categories/${editCategoryId}`, {
          method: 'PATCH',
        ...
        // Add mode
        res = await fetch('/api/business/categories', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload),
        });
      ...
      // Refresh list
      const updated = await fetch('/api/business/categories');
  ...
  async function handleDeleteCategory() {
    ...
    setDeleteError('');
    try {
      const res = await fetch(`/api/business/categories/${categoryToDelete.id}`, {
        method: 'DELETE',
      });
      if (!res.ok) {
        const data = await res.json();
